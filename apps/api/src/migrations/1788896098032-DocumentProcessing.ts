...
export class DocumentProcessing1788896098032 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "customer_settings" ("customer_id" character varying(128) NOT NULL, "callback_url" character varying(2000), "notification_mode" character varying(16) NOT NULL DEFAULT 'WEBSOCKET', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_f224ace74bd5446e75a00a11a10" PRIMARY KEY ("customer_id"))`,
    );
    await queryRunner.query(
